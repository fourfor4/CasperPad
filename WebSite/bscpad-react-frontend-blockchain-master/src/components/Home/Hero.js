    ...
    render() {
        return (
            <div className="container hero">
                <h2 className="text-center font-weight-bold text-white hero-title">CasperPad is the first official decentralized Launchpad built to launch next level projects on the Casper Network.</h2>
                <p className="text-center hero-description">CasperPad will empower crypto currency projects with the ability to distribute tokens and raise liquidity.</p>
                <div className="buttons">
                    <button type="button" className="btn btn-pro button-large">View All Projects</button>
