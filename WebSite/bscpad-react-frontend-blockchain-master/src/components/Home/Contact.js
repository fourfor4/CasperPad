        ...
        return (
            <section className="container contact">
                ...
                <ul className="rotation-container contact-list">
                    ...
                    <li><a href="www.google.com"><BiSupport className="social-link" />support@casperpad.com</a></li>
                    ...
                    <li><a href="www.google.com"><SiWebpack className="social-link" />www.casperpad.com</a></li>
                </ul>
            </section>
        );
    }
